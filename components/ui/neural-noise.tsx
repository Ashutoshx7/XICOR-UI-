...
const NeuralNoise = ({ children, className }: NeuralNoiseProps) => {
    ...
    `;
        ...
        function render() {
            ...
            pointer.x += (pointer.tX - pointer.x) * 0.5; // Increased sensitivity for smoother follow
    ...
    return (
        <div className={cn("relative w-full bg-[#151912]", className)} ref={containerRef}>
            <canvas
                ref={canvasRef}
                id="neuro"
